# Modified from https://github.com/duyphuongcri/Variational-AutoEncoder
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim):
        ...
        self.linear_up = nn.Linear(latent_dim, 55296)
        self.relu = nn.ReLU()
...
class VAE(nn.Module):
    def __init__(self, latent_dim=128):
        ...
        self.latent_dim = latent_dim
        self.z_mean = nn.Linear(55296, latent_dim)
        self.z_log_sigma = nn.Linear(55296, latent_dim)
